...
df["transparency"] = df["transparency"].fillna("Unknown").astype(str)
df = df[df["transparency"] != "Unknown"].copy()
...
joblib.dump(pipe, "outputs/models/rf_clf_transparency.pkl")
print("Saved: outputs/models/rf_clf_transparency.pkl")